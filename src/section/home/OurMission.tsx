          ...
          <div className="md:w-[85%] p-5 md:flex gap-5 w-full">
            ...
            <div className="w-full p-3 md:w-1/2">
              <div className="text-lg text-white">
                ...
                about empowering individuals to transform their lives through
                the power of coding. We believe that everyone should have access
                to high-quality, affordable coding education, regardless of
              ...
              <div className="pt-3 text-lg text-white">
                ...
                students in a personalized and supportive environment that
                fosters confidence and success. Our friendly and dedicated
                instructors are always available to guide and mentor our
                students, ensuring they receive the support they need to achieve
                their coding goals.
              </div>
            </div>
          </div>
