            ...
            <CommonContainer>
                ...
                <CommonSpace>
                    <div className="">
                        ...
                        <img src={htmlImg} alt="Html" className="lg:block md:hidden hidden w-16 absolute top-[160px] left-[160px] animate-rotated-bounce" />

                        <img src={reactImg} alt="React" className="lg:block md:hidden hidden w-16 absolute top-[250px] left-[250px] animate-custom-spin" />
                        <img src={reactImg} alt="React" className="lg:block md:hidden hidden w-16 absolute top-[160px] right-[160px] animate-custom-spin" />
                        <img src={tailwindImg} alt="Tailwind" className="lg:block md:hidden hidden w-16 absolute top-[250px] right-[250px] animate-swing-rotate" />
